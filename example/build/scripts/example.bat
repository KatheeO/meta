...
set CLASSPATH=%APP_HOME%\lib\example-1.0-SNAPSHOT.jar;%APP_HOME%\lib\persistence-1.0-SNAPSHOT.jar;%APP_HOME%\lib\annotations-1.0-SNAPSHOT.jar;%APP_HOME%\lib\sqlite-jdbc-3.49.0.0.jar


@rem Execute example
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EXAMPLE_OPTS%  -classpath "%CLASSPATH%" sk.tuke.meta.example.Main %*
